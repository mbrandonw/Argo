...
/**
  ...
  key exists but the object assigned to that key is unable to be decoded into
  the requested type, this will return `Failure`.
...
/**
  ...
  if the key exists but the objects assigned to that key are unable to be
  decoded into the requested type, this will return `Failure`.
